...
sim_table_long2 %>% #data frame
  group_by(sample_size) %>% #group by sample size
  summarize(Percent_Below = sum(value<=.06)) %>%  #is it less than .12
  print(n = nrow(.))
```
