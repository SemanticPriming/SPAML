...
The other files in each subfolder (possibly) include: 
  - `LANG_translated.xlsx`: a step between `LANG_translate.csv`
  and the finalized translations. Not included in all languages, but sometimes necessary when new fake words were needed be generated.
