...
file.rename(paste0(root, "data/", language, "/wiki.", language, ".1e6.vec"),
            paste0(root, "data/", language, "/wiki.", language, ".1e6.txt"))
af_vec <- read.table(paste0(root, "data/", language, "/wiki.", language, ".1e6.txt"), 
                     quote="\"")
