...
```{r}
trials$el_cue <- stri_replace_all_fixed(
  str = trials$el_cue, 
  pattern = DF$words, 
  replacement = DF$fix,
  vectorize_all = FALSE
...
trials$el_target <- stri_replace_all_fixed(
...
words_DF$el_cue <- stri_replace_all_fixed(
  str = words_DF$el_cue, 
  pattern = DF$words, 
  replacement = DF$fix,
  vectorize_all = FALSE
...
words_DF$el_target <- stri_replace_all_fixed(
...
matching$el_fake_cue <- stri_replace_all_fixed(
...
matching$el_fake_target <- stri_replace_all_fixed(
