...
# get patterns -----
ja_patterns <- read.hyph.pat("hyphen/hyph-en_us.tex", "en")
...
ja_subs <- ja_subs %>% filter(unigram != "")
...
# set up model
ja_model <- read.table("/Volumes/SPAML Backup/subs_vec/ja/subs.ja.1e6.txt", quote="\"")
