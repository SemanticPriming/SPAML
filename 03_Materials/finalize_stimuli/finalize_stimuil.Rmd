...
# fix real words ----
fa_update <- import("fa/fa_translated.xlsx") %>% 
  mutate(across(everything(), tolower))
...
# fix real words ----
he_update <- import("he/he_translated.xlsx") %>% 
  mutate(across(everything(), tolower))
...
## zh Traditional Chinese NEED WORDS
...
```{r eval = F}
# original words
es <- import("es/es_translate_wordpairs_checked.xlsx")
...
# fix real words ----
pl_update <- import("pl/pl_translated.xlsx") %>% 
  mutate(across(everything(), tolower))
...
```{r eval = F}
# fix real words ----
ro_update <- import("ro/ro_translate_updated nov 24 2022.xlsx") %>% 
  mutate(across(everything(), tolower))
