...
vi <- words[ , c("vi_cue", "vi_target", "vi_fake_cue", "vi_fake_target", 
                 "en_cue", "en_target")]
th$vi_cue <- tolower(th$vi_cue)
th$vi_target <- tolower(th$vi_target)
...
vi_fake_words <- get_fake(wordlist = vi_subs$unigram, #possibles
                          ...
                          replacewords = th$vi_cue) #your words
...
th$vi_fake_cue <- th$replacement_word
th$replacement_word <- NULL
...
vi_fake_words <- get_fake(wordlist = vi_subs$unigram, #possibles
                          language_hyp = vi_patterns, #hyphen rules
                          replacewords = th$vi_target) #your words
...
th$vi_fake_target <- th$replacement_word
th$replacement_word <- NULL
...
vi_trials <- rbind(vi_trials,
                   data.frame(vi_cue = th$vi_cue, 
                              vi_target = th$vi_target[sample(1:1000, 
                                                              1000)],
                              type = "unrelated",
                              cue_type = "word", 
                              target_type = "word"), 
                   data.frame(vi_cue = th$vi_fake_cue, 
                              vi_target = th$vi_target[sample(1:1000, 
                                                              1000)],
                              type = "nonword",
                              cue_type = "nonword", 
                              target_type = "word"),
                   data.frame(vi_cue = th$vi_cue[sample(1:1000,
                                                        1000)], 
                              vi_target = th$vi_fake_target,
                              type = "nonword",
                              cue_type = "word", 
                              target_type = "nonword"),
                   data.frame(vi_cue = th$vi_fake_cue[sample(1:1000,
                                                             1000)], 
                              vi_target = th$vi_fake_target[sample(1:1000,
                                                                   1000)],
                              type = "nonword",
                              cue_type = "nonword", 
                              target_type = "nonword"))
...
```{r eval = F}
# get data ----
th <- import("th/th_translated.xlsx")

th <- th[ , c("th_cue", "th_target", "th_fake_cue", "th_fake_target", 
                 "en_cue", "en_target")]
th$th_cue <- tolower(th$th_cue)
th$th_target <- tolower(th$th_target)

# create fake words based on cue
th_patterns <- read.hyph.pat("hyphen/hyph-th.tex", "th")
th_fake_words <- get_fake(wordlist = unique(c(th$th_cue, th$th_target)), #possibles
                          language_hyp = th_patterns, #hyphen rules
                          replacewords = th$th_cue) #your words

# merge back into data
th <- merge(th, 
            th_fake_words[ , c("original_word", "replacement_word")], 
            by.x = "th_cue", by.y = "original_word")
th$th_fake_cue <- th$replacement_word
th$replacement_word <- NULL
...
th_fake_words <- get_fake(wordlist = unique(c(th$th_cue, th$th_target)), #possibles
                          language_hyp = th_patterns, #hyphen rules
                          replacewords = th$th_target) #your words

# merge back into data
th <- merge(th, 
            th_fake_words[ , c("original_word", "replacement_word")], 
            by.x = "th_target", by.y = "original_word")
th$th_fake_target <- th$replacement_word
th$replacement_word <- NULL

export(th, "th/th_translated_update.xlsx", rowNames = F)
gc()
```