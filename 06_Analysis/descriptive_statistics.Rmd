...
The links to the language files can be found in our supplemental materials. The paper is presented with an upcoming *R* package `semanticprimeR` that allows one to open data files directly in *R* and a Shiny application [CITE shiny] to download a specific set of language files. The data can be cited using our Zenodo doi [CITE] which will indicate which version of the data was examined.   
