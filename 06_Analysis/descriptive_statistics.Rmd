...
ggsave("images/binned_country.png", dpi = 300)
```
...
flextable(prime.lang) %>% 
  ...
  set_footnote("Note. UR = Unrelated trials, R = related trials, M = mean Z-scored response latency, N = mean number of trials.")
```
