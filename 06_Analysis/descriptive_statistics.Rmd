...
langs_trial <- paste(paste0("/", langs, "_"), collapse = "|")
...
t.overall.keepanswered <- c(nrow(t.df %>% 
...
# average z-score response latencies
z.overall <- c(t.df %>% 
                 pull(Z_RT) %>% 
                 mean(., na.rm = T), 
             t.df %>% 
