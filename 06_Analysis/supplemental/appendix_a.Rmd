...
-   Codebooks:
    ...
    -   Codebook full data:
    -   Codebook item data:
    -   Codebook participant data:
    -   Codebook priming trial level data:
    -   Codebook priming summarized level data:
    -   Summary table of the sample size calculations:
    -   Codebook trial data:
...
-   Supplemental Tables/Summaries:
    ...
    -   Reliability data files:
        ...
        -   Person Reliability: <https://osf.io/jf28q>
