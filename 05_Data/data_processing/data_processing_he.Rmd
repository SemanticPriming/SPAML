...
# figure out trial type ----
  ...
  export(priming_Z, "output_data/priming_data/he_prime_trials.csv", row.names = F)
...
# figure out trial type ----
  ...
  priming_Z <- priming_focus %>% 
    ...
    export(priming_Z, "output_data/priming_data/he_answered_prime_trials.csv", row.names = F)
