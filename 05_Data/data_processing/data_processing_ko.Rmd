...
# figure out trial type ----
  ...
  export(priming_Z, "output_data/priming_data/ko_prime_trials.csv", row.names = F)
...
# figure out trial type ----
  ...
  export(priming_Z, "output_data/priming_data/ko_answered_prime_trials.csv", row.names = F)
