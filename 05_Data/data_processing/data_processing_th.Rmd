...
# figure out trial type ----
  ...
  export(priming_Z, "output_data/priming_data/th_prime_trials.csv", row.names = F)
...
# figure out trial type ----
  ...
  export(priming_Z, "output_data/priming_data/th_answered_prime_trials.csv", row.names = F)
