...
```{r import_data, eval = T, message = F}
# get all the files
...
```{r stimuli_merge_answered, eval = T}
##merge with stimuli data
# item_data <- merge(item_data_combo,
#                    lexops, 
#                    by.x = "word", 
...
# figure out trial type ----
  ...
  export(priming_Z, "output_data/priming_data/ro_prime_trials.csv", row.names = F)
...
# figure out trial type ----
  ...
  export(priming_Z, "output_data/priming_data/ro_answered_prime_trials.csv", row.names = F)
