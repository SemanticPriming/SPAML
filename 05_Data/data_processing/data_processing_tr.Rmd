...
write.csv(item_data_combo, "output_data/item_data/vtr_item_data.csv", row.names = F)
```
...
# figure out trial type ----
  ...
  export(priming_Z, "output_data/priming_data/tr_prime_trials.csv", row.names = F)
...
# figure out trial type ----
  ...
  export(priming_Z, "output_data/priming_data/tr_answered_prime_trials.csv", row.names = F)
