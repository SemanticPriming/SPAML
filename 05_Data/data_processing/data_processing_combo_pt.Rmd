...
```{r}
  ...
  export(priming_Z, "output_data/priming_data/pt_combo_answered_prime_trials.csv", row.names = F)
...
```{r}
  ...
  export(priming_Z, "output_data/priming_data/br_pt_combo_answered_prime_trials.csv", row.names = F)
