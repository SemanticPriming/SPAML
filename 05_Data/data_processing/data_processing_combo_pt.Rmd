...
write.csv(pt_data_all, 
       gzfile("output_data/full_data/pt_full_data.csv.gz"),
       row.names = F)
```
...
```{r}
  ...
  export(priming_Z, "output_data/priming_data/pt_combo_prime_trials.csv", row.names = F)
...
```{r}
  ...
  export(priming_Z, "output_data/priming_data/br_pt_combo_prime_trials.csv", row.names = F)
...
```{r}
  ...
  export(priming_Z, "output_data/priming_data/pt_answered_prime_trials.csv", row.names = F)
...
```{r}
  ...
  export(priming_Z, "output_data/priming_data/br_pt_answered_prime_trials.csv", row.names = F)
