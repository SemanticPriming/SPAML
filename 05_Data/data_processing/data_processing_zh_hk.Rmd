...
# figure out trial type ----
  ...
  export(priming_Z, "output_data/priming_data/zh_hk_prime_trials.csv", row.names = F)
...
# figure out trial type ----
  ...
  export(priming_Z, "output_data/priming_data/zh_hk_answered_prime_trials.csv", row.names = F)
