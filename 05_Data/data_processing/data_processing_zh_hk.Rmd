...
# figure out trial type ----
  ...
  export(priming_Z, "output_data/priming_data/zh_hk_priming_trials.csv", row.names = F)
...
write.csv(priming_Z_summary, "output_data/priming_data/zh_hk_prime_data.csv", row.names = F)
write.csv(priming_Z_summary_no2.5, "output_data/priming_data/zh_hk_prime_data_no2.5.csv", row.names = F)
write.csv(priming_Z_summary_no3.0, "output_data/priming_data/zh_hk_prime_data_no3.0.csv", row.names = F)
```
...
##write out the priming data 
write.csv(priming_Z_summary, "output_data/priming_data/zh_hk_answered_prime_data.csv", row.names = F)
write.csv(priming_Z_summary_no2.5, "output_data/priming_data/zh_hk_answered_prime_data_no2.5.csv", row.names = F)
write.csv(priming_Z_summary_no3.0, "output_data/priming_data/zh_hk_answered_prime_data_no3.0.csv", row.names = F)
```
