...
# figure out trial type ----
  ...
  export(priming_Z, "output_data/priming_data/da_prime_trials.csv", row.names = F)
...
# figure out trial type ----
  ...
  export(priming_Z, "output_data/priming_data/da_answered_prime_trials.csv", row.names = F)
