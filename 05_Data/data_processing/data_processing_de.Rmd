...
# figure out trial type ----
  ...
  export(priming_Z, "output_data/priming_data/de_prime_trials.csv", row.names = F)
...
# figure out trial type ----
  ...
  table(priming_Z$type, useNA = "ifany")
    ...
    export(priming_Z, "output_data/priming_data/de_answered_prime_trials.csv", row.names = F)
