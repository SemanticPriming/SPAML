...
# figure out trial type ----
  ...
  export(priming_Z, "output_data/priming_data/nl_prime_trials.csv", row.names = F)
...
# figure out trial type ----
  ...
  export(priming_Z, "output_data/priming_data/nl_answered_prime_trials.csv", row.names = F)
