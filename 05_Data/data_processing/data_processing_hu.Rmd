...
write.csv(priming_Z_summary, "output_data/priming_data/hu_prime_data.csv", row.names = F)
write.csv(priming_Z_summary_no2.5, "output_data/priming_data/hu_prime_data_no2.5.csv", row.names = F)
write.csv(priming_Z_summary_no3.0, "output_data/priming_data/hu_prime_data_no3.0.csv", row.names = F)
```
...
##write out the priming data 
write.csv(priming_Z_summary, "output_data/priming_data/hu_answered_prime_data.csv", row.names = F)
write.csv(priming_Z_summary_no2.5, "output_data/priming_data/hu_answered_prime_data_no2.5.csv", row.names = F)
write.csv(priming_Z_summary_no3.0, "output_data/priming_data/hu_answered_prime_data_no3.0.csv", row.names = F)
```
