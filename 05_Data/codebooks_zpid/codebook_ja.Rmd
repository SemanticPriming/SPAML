---
title: "SPAML Japanese Data Outputs"
output:
  html_document:
    toc: true
    toc_depth: 4
...
```{r prepare_codebook}
library(codebook)
codebook_data <- import("output_data/ja_full_data.csv.gz")
