...
# original word lists
sl_words <- import("/var/www/html/sl/sl_words.csv")

# collected data
sl_data_all <-
  list(processData("/var/www/html/sl/data/data.sqlite") %>%
...
list_sl_data <- lapply(list.files(path = "/var/www/html/summary_data",
...
write.csv(sl_merged, "/var/www/html/summary_data/sl_summary.csv", row.names = F)
...
write.csv(p_lab, "/var/www/html/summary_data/sl_participants.csv", row.names = F)
