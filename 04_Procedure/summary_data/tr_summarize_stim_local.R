...
# collected data
tr_data_all <-
  list(processData("./04_Procedure/tr/data/data.sqlite") %>%
...
list_tr_data <- lapply(list.files(path = "./04_Procedure/summary_data",
...
write.csv(tr_merged, "./04_Procedure/summary_data/tr_summary.csv", row.names = F)
