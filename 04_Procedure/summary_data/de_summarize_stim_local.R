...
# original word lists
de_words <- import("./04_Procedure/de/de_words.csv")

# collected data
de_data_all <-
  list(processData("./04_Procedure/de/data/data.sqlite") %>%
...
# generate summary chart for shiny ----
  write.csv(de_merged, "./04_Procedure/summary_data/de_summary.csv", row.names = F)
