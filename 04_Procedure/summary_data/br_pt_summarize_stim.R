...
# original word lists
br_pt_words <- import("/var/www/html/br_pt/br_pt_words.csv")
...
write.csv(br_pt_merged, "/var/www/html/summary_data/br_pt_summary.csv", row.names = F)
...
write.csv(p_lab, "/var/www/html/summary_data/br_pt_participants.csv", row.names = F)
