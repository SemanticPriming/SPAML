...
list_he_data <- lapply(list.files(path = "/var/www/html/summary_data",
...
write.csv(he_merged, "/var/www/html/summary_data/he_summary.csv", row.names = F)
...
write.csv(p_lab, "/var/www/html/summary_data/he_participants.csv", row.names = F)
