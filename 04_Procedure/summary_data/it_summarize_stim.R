...
# original word lists
it_words <- import("/var/www/html/it/it_words.csv")
...
list_it_data <- lapply(list.files(path = "/var/www/html/summary_data",
...
write.csv(it_merged, "/var/www/html/summary_data/it_summary.csv", row.names = F)
...
write.csv(p_lab, "/var/www/html/summary_data/it_participants.csv", row.names = F)
