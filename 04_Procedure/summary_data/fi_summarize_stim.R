...
list_fi_data <- lapply(list.files(path = "/var/www/html/summary_data",
...
write.csv(fi_merged, "/var/www/html/summary_data/fi_summary.csv", row.names = F)
...
write.csv(p_lab, "/var/www/html/summary_data/fi_participants.csv", row.names = F)
