...
list_ur_data <- lapply(list.files(path = "/var/www/html/summary_data",
...
write.csv(ur_merged, "/var/www/html/summary_data/ur_summary.csv", row.names = F)
...
write.csv(p_lab, "/var/www/html/summary_data/ur_participants.csv", row.names = F)
