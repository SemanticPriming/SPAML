...
# original word lists
zh_hk_words <- import("/var/www/html/zh_hk/zh_hk_words.csv")
...
list_zh_hk_data <- lapply(list.files(path = "/var/www/html/summary_data",
...
write.csv(zh_hk_merged, "/var/www/html/summary_data/zh_hk_summary.csv", row.names = F)
...
write.csv(p_lab, "/var/www/html/summary_data/zh_hk_participants.csv", row.names = F)
