...
# original word lists
th_words <- import("/var/www/html/th/th_words.csv")
...
list_th_data <- lapply(list.files(path = "/var/www/html/summary_data",
...
write.csv(th_merged, "/var/www/html/summary_data/th_summary.csv", row.names = F)
...
write.csv(p_lab, "/var/www/html/summary_data/th_participants.csv", row.names = F)
