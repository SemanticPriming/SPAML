...
# collected data
ru_data_all <- 
  bind_rows(processData("./04_Procedure/ru/data/data.sqlite") %>% 
              mutate(url_lab = as.character(url_lab)),
            processData("./04_Procedure/ru1/data/data.sqlite") %>% 
              mutate(url_lab = as.character(url_lab)),
            processData("./04_Procedure/ru2/data/data.sqlite") %>% 
              mutate(url_lab = as.character(url_lab)),
            processData("./04_Procedure/ru3/data/data.sqlite") %>% 
              mutate(url_lab = as.character(url_lab)),
            processData("./04_Procedure/ru4/data/data.sqlite") %>% 
              mutate(url_lab = as.character(url_lab)),
            processData("./04_Procedure/ru5/data/data.sqlite") %>% 
              mutate(url_lab = as.character(url_lab)),
            processData("./04_Procedure/ru6/data/data.sqlite") %>% 
              mutate(url_lab = as.character(url_lab)),
            processData("./04_Procedure/ru7/data/data.sqlite") %>% 
              mutate(url_lab = as.character(url_lab)),
            processData("./04_Procedure/ru8/data/data.sqlite") %>% 
              mutate(url_lab = as.character(url_lab)),
            processData("./04_Procedure/ru9/data/data.sqlite") %>% 
              mutate(url_lab = as.character(url_lab)),
            processData("./04_Procedure/ru10/data/data.sqlite") %>% 
              mutate(url_lab = as.character(url_lab)),
            processData("./04_Procedure/ru11/data/data.sqlite") %>% 
              mutate(url_lab = as.character(url_lab)),
            processData("./04_Procedure/ru12/data/data.sqlite") %>% 
              mutate(url_lab = as.character(url_lab)),
            processData("./04_Procedure/ru13/data/data.sqlite") %>% 
...
write.csv(participant_DF %>% select(please_tell_us_your_gender, keep, url_special_code), 
          "./04_Procedure/summary_data/ru_totals.csv", row.names = F)
...
write.csv(ru_merged, "./04_Procedure/summary_data/ru_summary.csv", row.names = F)
...
write.csv(p_lab, "./04_Procedure/summary_data/ru_participants.csv", row.names = F)
...
if (static == TRUE){
  ...
  temp <- subset(ru_merged, 
                 ru_merged$cue_type == "nonword" &
                   ru_merged$target_type == "nonword")
  # shuffle the words 
