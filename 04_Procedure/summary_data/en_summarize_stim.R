...
# add in url_lab
en_data_all$url_lab[en_data_all$observation %in% dup_rows$observation &
                      en_data_all$sender_id == 1] <- 2772
...
list_en_data <- lapply(list.files(path = "/var/www/html/summary_data",
