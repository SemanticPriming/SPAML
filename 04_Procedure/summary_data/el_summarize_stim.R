...
# original word lists
el_words <- import("/var/www/html/el/el_words.csv")
...
list_el_data <- lapply(list.files(path = "/var/www/html/summary_data",
...
write.csv(el_merged, "/var/www/html/summary_data/el_summary.csv", row.names = F)
...
write.csv(p_lab, "/var/www/html/summary_data/el_participants.csv", row.names = F)
