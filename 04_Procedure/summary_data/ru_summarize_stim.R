...
list_ru_data <- lapply(list.files(path = "/var/www/html/summary_data",
...
write.csv(ru_merged, "/var/www/html/summary_data/ru_summary.csv", row.names = F)
