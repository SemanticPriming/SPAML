...
# original word lists
ro_words <- import("/var/www/html/ro/ro_words.csv")
...
list_ro_data <- lapply(list.files(path = "/var/www/html/summary_data",
...
write.csv(ro_merged, "/var/www/html/summary_data/ro_summary.csv", row.names = F)
...
write.csv(p_lab, "/var/www/html/summary_data/ro_participants.csv", row.names = F)
