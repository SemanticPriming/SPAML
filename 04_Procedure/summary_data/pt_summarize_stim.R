...
# original word lists
pt_words <- import("/var/www/html/pt/pt_words.csv")
...
pt_data_all <-
  list(processData("/var/www/html/pt/data/data.sqlite") %>% 
       ...
       processData("/var/www/html/pt1/data/data.sqlite") %>% 
         mutate_at(vars(one_of("url_lab")), as.character,
                   vars(one_of("url_special_code")), as.character),
       processData("/var/www/html/pt2/data/data.sqlite") %>% 
         mutate_at(vars(one_of("url_lab")), as.character,
                   vars(one_of("url_special_code")), as.character),
       processData("/var/www/html/pt3/data/data.sqlite") %>% 
         mutate_at(vars(one_of("url_lab")), as.character,
                   vars(one_of("url_special_code")), as.character),
       processData("/var/www/html/pt4/data/data.sqlite") %>% 
         mutate_at(vars(one_of("url_lab")), as.character,
                   vars(one_of("url_special_code")), as.character),
       processData("/var/www/html/pt5/data/data.sqlite") %>% 
         mutate_at(vars(one_of("url_lab")), as.character,
                   vars(one_of("url_special_code")), as.character)) 
...
write.csv(pt_merged, "/var/www/html/summary_data/pt_summary.csv", row.names = F)
...
write.csv(p_lab, "/var/www/html/summary_data/pt_participants.csv", row.names = F)
