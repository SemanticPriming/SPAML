...
if(this.state.dominanthand == "left") {
  ...
  window.nonword_key = 'z'
      ...
      "content": "\u003Cmain class=\"content-horizontal-center content-vertical-center\"\u003E\n \n  \u003Cdiv style=\"width: 90%;\"\u003E\n      \n    \u003Ch2\u003Eהוראות\u003C\u002Fh2\u003E\n    \u003Cp class=\"text-right\" dir = \"rtl\"\u003Eניסוי זה עוסק באופן שבו אנשים מעבדים מילים. תתבקשו לראות מילים ולשפוט אותן.\u003C\u002Fp\u003E\n\n    \u003Cp class=\"text-right\" dir = \"rtl\"\u003E המילים יוצגו במרכז המסך. עליכם לשאול את עצמכם האם המילה על המסך היא מילה אמיתית או מילה מזויפת (לא אמיתית).\u003C\u002Fp\u003E\n\n    \u003Cp class=\"text-right\" dir = \"rtl\"\u003E אם אתם מזהים את המילה כמילה אמיתית, לדוגמא קור, עליכם ללחוץ על המקש \u003Ckbd\u003E${ window.word_key }\u003C\u002Fkbd\u003E למילה אמיתית. אם אתם מזהים את המילה כמילה לא אמיתית, לדוגמא חומאל, עליכם ללחוץ על המקש \u003Ckbd\u003E${ window.nonword_key }\u003C\u002Fkbd\u003E למילה מזויפת. בשלב האימון ניתן לכם משוב.\n \u003C\u002Fp\u003E\n\n    \u003Cp class=\"text-right\" dir = \"rtl\"\u003E נבקשכם להשיב מהר ככל הניתן תוך כדי הקפדה על דיוק בתשובותיכם.\n לרשותכם שָׁלוֹשׁ שניות לענות על כל מילה.\u003C\u002Fp\u003E\n  \n  \u003C\u002Fdiv\u003E\n\n\u003C\u002Fmain\u003E\n\n\u003Cfooter dir = \"rtl\"\u003E\n  אנא הקש על \u003Ckbd\u003Eמקש הרווח\u003C\u002Fkbd\u003E כדי לנסות כמה לתרגול.\n\u003C\u002Ffooter\u003E",
      "plugins": [],
      "scrollTop": true,
      "tardy": true
    },
    {
      ...
      "context": "\u003Cmain\u003E\n\u003C!-- Nested components use this canvas --\u003E\n  \u003Ccanvas \u002F\u003E\n\u003C\u002Fmain\u003E\n\u003Cfooter dir = \"rtl\"\u003Eאנא הקש \u003Ckbd\u003E${ window.word_key }\u003C\u002Fkbd\u003E אם האמור לעיל הוא מילה אמיתית, ועל \u003Ckbd\u003E${ window.nonword_key }\u003C\u002Fkbd\u003E אם זו מילה מזויפת.\n\u003C\u002Ffooter\u003E",
...
this.parameters.feedback = this.state.ended_on !== 'response'
  ...
  : (
    ...
    },
    {
      ...
      "content": "\u003Cmain class=\"content-horizontal-center content-vertical-center\"\u003E\n  \n  \u003Cdiv style=\"width: 90%;\"\u003E\n    \n    \u003Ch2\u003Eהוראות\u003C\u002Fh2\u003E\n    \n    \u003Cp class=\"text-right\" dir = \"rtl\"\u003Eכל הכבוד! זכרו שאתם צריכים להשתמש במקש \u003Ckbd\u003E${ window.word_key }\u003C\u002Fkbd\u003E למילים אמיתיות, ובמקש \u003Ckbd\u003E${ window.nonword_key } \u003C\u002Fkbd\u003E  למילים מזויפות.\u003C\u002Fp\u003E\n\n\n\n    \u003Cp class=\"text-right\" dir = \"rtl\"\u003E כעת תשלימו את המשימה האמיתית. זכרו שעליכם להשלים כל מילה מהר ככל הניתן תוך כדי דיוק בתשובה בה תבחרו. \n\nבשלב זה לא תקבלו משוב.\n\u003C\u002Fp\u003E\n  \n  \u003C\u002Fdiv\u003E\n\n\u003C\u002Fmain\u003E\n\n\u003Cfooter dir = \"rtl\"\u003E\n אנא הקישו על מקש הרווח \u003Ckbd\u003E(SPACE BAR)\u003C\u002Fkbd\u003E כדי להמשיך.\n\u003C\u002Ffooter\u003E",
      "tardy": true
    },
    {
      "type": "lab.canvas.Frame",
      "context": "\u003Cmain\u003E\n\u003C!-- Nested components use this canvas --\u003E\n  \u003Ccanvas \u002F\u003E\n\u003C\u002Fmain\u003E\n\u003Cfooter dir = \"rtl\"\u003E\n\n  אנא הקישו על המקש \u003Ckbd\u003E${ window.word_key }\u003C\u002Fkbd\u003E למילה אמיתית, ועל המקש \u003Ckbd\u003E${ window.nonword_key }\u003C\u002Fkbd\u003E למילה מזויפת. \n\u003C\u002Ffooter\u003E",
      "contextSelector": "canvas",
      "files": {},
      "parameters": {},
      "responses": {
...
this.options.templateParameters = await response.json()
    ...
    },
    {
      ...
      "content": "\u003Cmain class=\"content-horizontal-center content-vertical-center\"\u003E\n\n    \u003Cdiv style=\"width: 90%;\"\u003E\n\n    \u003Ch2 dir = \"rtl\"\u003Eתודה!\u003C\u002Fh2\u003E\n    \n    \u003Cp class=\"text-right\" dir = \"rtl\"\u003Eסיימתם את הניסוי.\u003C\u002Fp\u003E\n\n\u003Cp class=\"text-right\" dir = \"rtl\"\u003E\nמזהה המשתתף האקראי שלכם הוא ${ window.uuid }.\u003C\u002Fp\u003E\n\n\u003Cp class=\"text-right\" dir = \"rtl\"\u003E\nבכדי שנוכל לתת לכם נקודות קרדיט, עליכם להעתיק את מזהה המשתתף האקראי שקיבלתם למעלה ולהזינו בטופס השלמת הניסוי. \u003C\u002Fp\u003E\n\n\u003Cp class=\"text-right\" dir = \"rtl\"\u003E\nכעת העתיקו את מזהה המשתתף האקראי ולחצו על הלינק הבא כדי לעבור לטופס השלמת הניסוי: \n\u003Ca href=\"https:\u002F\u002Ftinyurl.com\u002F2rfe3dz7\"\u003Ehttps:\u002F\u002Ftinyurl.com\u002F2rfe3dz7\u003C\u002Fa\u003E \u003C\u002Fp\u003E\n \n\u003Cp class=\"text-right\" dir = \"rtl\"\u003E\nחשוב: לא נוכל לתת נקודות קרדיט לסטודנטים עם מזהה משתתף חסר או שגוי. מומלץ גם לשמור את הקוד אצלכם.\n\n    \u003C\u002Fp\u003E\n\n  \u003C\u002Fdiv\u003E\n\u003C\u002Fmain\u003E\n\n\u003Cfooter dir = \"rtl\"\u003E\n כעת תוכל לסגור את החלון.\n\u003C\u002Ffooter\u003E",
      "plugins": [],
      "tardy": true
    }
  ]
