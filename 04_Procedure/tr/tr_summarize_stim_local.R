...
# original word lists
tr_words <- import("./04_Procedure/tr/tr_words.csv")

# collected data
tr_data_all <- processData("./04_Procedure/tr/data/data.sqlite")
...
# are we done? ---- 
  tr_Z_summary$done <- (tr_Z_summary$sampleN >= 50 & tr_Z_summary$SE_Z <= .09) | tr_Z_summary$sampleN >= 320
...
# generate summary chart for shiny ----
  write.csv(tr_merged, "./04_Procedure/tr/data/tr_summary.csv", row.names = F)
...
# generate participant report for shiny ----
  ...
  write.csv(p_lab, "./04_Procedure/tr/data/tr_participants.csv", row.names = F)
...
practice <- '[
  ...
  writeLines(practice, con = "./04_Procedure/tr/embedded/db6cc958e11fc3987cebacc1e14b253b95b4de4d05c702ecbb3294775adb3e4b.json")
  ...
  real <- paste('[', 
                ...
                ']', collapse = "", sep = "")
  writeLines(real, con = "./04_Procedure/tr/embedded/3cee33bcfe0a7bdac59ec1374ca41a4ea7fe6e772c9b0ab0770f0d1f5cb09e41.json")
  ...
  real <- paste('[', 
                ...
                ']', collapse = "", sep = "")
  writeLines(real, con = "./04_Procedure/tr/embedded/ae2c5987efa101760004c66c0da975c7dd75605ada53cabf75ec439ce68a5871.json")
  ...
  real <- paste('[', 
                ...
                ']', collapse = "", sep = "")
  writeLines(real, con = "./04_Procedure/tr/embedded/3a95e1234833448efe1e098102f00e2f4bb85d6edd8b6a093f62a93d4dcf4f4e.json")
  ...
  real <- paste('[', 
                ...
                ']', collapse = "", sep = "")
  writeLines(real, con = "./04_Procedure/tr/embedded/994ac7a5038c8713adb715e04d6639acda5d02a40abdb81d59c0d39dfea6cf06.json")
  ...
  real <- paste('[', 
                ...
                ']', collapse = "", sep = "")
  writeLines(real, con = "./04_Procedure/tr/embedded/9febe5343449a1c79d42f597f494397c595dd944600a7908e38167bbb18234ee.json")
  ...
  real <- paste('[', 
                ...
                ']', collapse = "", sep = "")
  writeLines(real, con = "./04_Procedure/tr/embedded/cd99c6e5b4b714268551fce4fc08729821a7bdb4a6f2294152b2e0d5e4ddfb99.json")
  ...
  real <- paste('[', 
                ...
                ']', collapse = "", sep = "")
  writeLines(real, con = "./04_Procedure/tr/embedded/c378cfb94011283fa98a84e5e2d34272f4a3134cda08298ed211f9c6c2331757.json")
  ...
  real <- paste('[', 
                ...
                ']', collapse = "", sep = "")
  writeLines(real, con = "./04_Procedure/tr/embedded/0d00e4cacc8fbd59aa34a45be41f535ccade17517701d1b3fa6ef139ca8746a3.json")
