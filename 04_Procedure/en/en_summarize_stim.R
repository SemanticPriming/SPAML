...
real <- paste('[', 
              ...
              ']', collapse = "", sep = "")
writeLines(real, con = "/var/www/html/en/embedded/c378cfb94011283fa98a84e5e2d34272f4a3134cda08298ed211f9c6c2331757.json")
...
real <- paste('[', 
              ...
              ']', collapse = "", sep = "")
writeLines(real, con = "/var/www/html/en/embedded/0d00e4cacc8fbd59aa34a45be41f535ccade17517701d1b3fa6ef139ca8746a3.json")
